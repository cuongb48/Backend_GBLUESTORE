            ...
            const mailOptions = {
                ...
                html: `
                        <div style="max-width: 600px; margin: 0 auto; font-family: Arial, sans-serif; background-color: #f9f9f9; padding: 20px; border-radius: 10px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                            ...
                            <p style="text-align: center; font-size: 16px;">Bạn có thể theo dõi đơn hàng tại <a href="https://shopbandoAnime.buihungcuong.site" style="color: #3498db; text-decoration: none;">WebShop Bùi Cường</a></p>
                        </div>
                    `
            };
            ...
            const mailOptions = {
                ...
                html: `
                    <div style="max-width: 600px; margin: 0 auto; font-family: Arial, sans-serif; background-color: #f9f9f9; padding: 20px; border-radius: 10px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                        ...
                        <p style="text-align: center; font-size: 16px;">📦 Bạn có thể theo dõi đơn hàng tại <a href="https://shopbandoAnime.buihungcuong.site" style="color: #3498db; text-decoration: none; font-weight: bold;">WebShop Bùi Cường</a></p>
                    </div>
                `
            };
            ...
            const mailOptions = {
                ...
                html: `
                    <div style="max-width: 600px; margin: 0 auto; font-family: Arial, sans-serif; background-color: #f9f9f9; padding: 20px; border-radius: 10px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                        ...
                        <p style="text-align: center; font-size: 16px;">Admin có thể quản lý đơn hàng tại <a href="https://shopbandoAnime.buihungcuong.site/admin" style="color: #3498db; text-decoration: none;">Trang Quản Lý</a></p>
                    </div>
                `
            };
...
const createOrderThanhToanVNPay = async (req, res) => {
    try {
        ...
        // const returnUrl = req.body?.returnUrl || 'https://backend-bandoAnime-node.buihungcuong.site/api/order/vnpay_return';
        const returnUrl = req.body?.returnUrl || 'https://backendgbluestore.dantri24h.com/api/order/vnpay_return';
